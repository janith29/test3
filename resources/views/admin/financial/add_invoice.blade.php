    ...
    <div class="row title-section">
        ...
        <div class="col-8 col-md-4" style="padding-bottom: 15px;">
            ...
            <div class="right-searchbar">
                <!-- Search form -->
                <form action="searchpatientin" method="post" class="form-inline active-cyan-3">
                        {{ csrf_field() }}
                        <input type="text" placeholder="Search Patient name,ID, NIC" name="search" class="form-control form-control-sm ml-3 w-100" required>
